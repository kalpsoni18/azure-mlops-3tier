# =============================================================================
# Variables — All behavior controlled here via terraform.tfvars
# =============================================================================

# --- General ---
variable "project" { type = string; default = "mlops3tier" }
...
variable "aks_node_min" { type = number; default = 1 }
variable "aks_node_max" { type = number; default = 2 }
...
variable "db_geo_backup" { type = bool; default = false }
...
variable "prometheus_retention" { type = string; default = "3d" }
variable "prometheus_storage" { type = string; default = "5Gi" }
variable "grafana_service_type" { type = string; default = "LoadBalancer" }

variable "loki_retention" { type = string; default = "168h" }
variable "loki_storage"   { type = string; default = "5Gi" }
